...
export function initBeforeVisitCarousel() {
  const viewport = document.getElementById("before-visit-carousel-viewport");
  const track = document.getElementById("before-visit-carousel-track");
  const dotsRoot = document.getElementById("before-visit-carousel-dots");
  const prevButton = document.getElementById("before-visit-carousel-prev");
  const nextButton = document.getElementById("before-visit-carousel-next");
...
export function updateBeforeVisitCarouselDotsI18n() {
  const dotsRoot = document.getElementById("before-visit-carousel-dots");
  if (!dotsRoot) {
    return;
  }
