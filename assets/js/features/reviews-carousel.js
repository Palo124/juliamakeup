...
export function initReviewsCarousel() {
  ...
  const dotsRoot = document.getElementById("reviews-carousel-dots");
  const prevButton = document.getElementById("reviews-carousel-prev");
  const nextButton = document.getElementById("reviews-carousel-next");
...
export function updateReviewsCarouselDotsI18n() {
  const dotsRoot = document.getElementById("reviews-carousel-dots");
  if (!dotsRoot) {
    return;
  }
