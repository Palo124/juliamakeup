...
const BUNDLED_STRINGS = {
  en: {
    ...
    "meta.descriptionPromLanding":
      "Soft glam, glow, and a look that feels like the best version of you. Prom makeup in Bratislava matched to your features, dress, and the night.",
    ...
    "review.savingRating": "Saving your rating…",
    "review.savingRatingBody": "Please wait a moment.",
    "review.formTitle": "Thank you!",
    "review.formIntro": "Would you like to add a short note? (optional)",
    "review.commentLabel": "Your note",
    "review.commentTopicsIntro": "You could mention, for example:",
    "review.commentTopicApproach": "approach",
    "review.commentTopicLongevity": "makeup longevity",
    "review.commentTopicResult": "makeup result",
    "review.commentTopicAtmosphere": "atmosphere",
    "review.commentTopicOverall": "overall impression",
    "review.commentPlaceholder": "A few words are enough…",
    "review.submit": "Send note",
    "review.skip": "Skip",
    ...
    "review.ratingLocked": "Your rating was already saved from this link.",
    "review.serverError": "Could not save your feedback. Please try again.",
    "review.rating1": "Not satisfied",
    "review.rating2": "Satisfied",
    "review.rating3": "Very satisfied",
    "meta.titleReview": "Juliére Beauty | Your feedback",
    "meta.descriptionReview": "Share quick feedback after your visit at Juliére Beauty.",
  ...
  sk: {
    ...
    "review.savingRating": "Ukladám hodnotenie…",
    "review.savingRatingBody": "Prosím počkajte.",
    "review.formTitle": "Ďakujeme!",
    "review.formIntro": "Voliteľne nám napíšte, čo sa vám páčilo alebo čo by sme mohli zlepšiť.",
    "review.commentLabel": "Poznámka",
    "review.commentTopicsIntro": "Môžete napísať napríklad o:",
    "review.commentTopicApproach": "prístupe",
    "review.commentTopicLongevity": "výdrži líčenia",
    "review.commentTopicResult": "výsledku líčenia",
    "review.commentTopicAtmosphere": "atmosfére",
    "review.commentTopicOverall": "celkovom dojme",
    "review.commentPlaceholder": "Stačí pár slov…",
    "review.submit": "Odoslať poznámku",
    "review.skip": "Preskočiť",
    ...
    "review.invalidRating": "Zvoľte prosím hodnotenie cez odkazy v e-maile.",
    "review.ratingLocked": "Hodnotenie z tohto odkazu už bolo uložené.",
    "review.serverError": "Spätnú väzbu sa nepodarilo uložiť. Skúste to prosím znova.",
    "review.rating1": "Nízka spokojnosť",
    "review.rating2": "Stredná spokojnosť",
    "review.rating3": "Vysoká spokojnosť",
    "meta.titleReview": "Juliére Beauty | Spätná väzba",
    "meta.descriptionReview": "Krátka spätná väzba po návšteve v štúdiu Juliére Beauty.",
