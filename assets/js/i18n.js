...
const BUNDLED_STRINGS = {
  en: {
    ...
    "about.p2":
      "Browse services and pricing, then reserve online — from first click to your appointment, everything stays clear and calm.",
    ...
    "faq.a1":
      "Use “Reserve now” above, pick a date and time in the calendar, then submit your details. Julia will confirm.",
    "faq.q2": "Can I change or cancel?",
    "faq.a2":
      "Contact the studio as soon as your plans shift. If you are signed in on this device, you can cancel from your booking list.",
    ...
    "faq.a4":
      "Mention it in your notes when booking. Julia uses professional products and can adjust the routine to your needs.",
  ...
  sk: {
    ...
    "about.p2":
      "Prezrite si služby a cenník, rezervujte online — od prvého kliku až po vizitku je všetko prehľadné a pokojné.",
    ...
    "faq.a1":
      "Kliknite na „Rezervovať teraz“ vyššie, vyberte dátum a čas v kalendári a odošlite údaje. Julia vás potvrdí.",
    "faq.q2": "Môžem zmeniť alebo zrušiť rezerváciu?",
    "faq.a2":
      "Čo najskôr napíšte štúdiu. Ak ste prihlásená na tomto zariadení, zrušiť môžete aj v zozname rezervácií.",
    ...
    "faq.a4":
      "Uveďte to v poznámke pri rezervácii. Julia používa profesionálne produkty a postup prispôsobí vašim potrebám.",
